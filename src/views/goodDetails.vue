  ...
  <div class="container">
    <div class="container1">
      ...
      <div class="container4">
        ...
        <br/>
        <img src="../components/icon/ipad1.png" style="margin-top: 10px">
        <img src="../components/icon/ipad2.png">
      </div>
    </div>
  ...
  export default {
    ...
    methods:{
      myfun(){
        ...
        var div2=document.getElementById("container3");
