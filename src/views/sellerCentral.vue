            ...
            <div class="container-1-2" style="text-align: center;">
              ...
              <div style="margin: auto">
                <el-row :gutter="10" style="font-size: 22px;font-weight: bold" class="state">
                  <el-col :span="4"><div class="grid-content bg-urple" style="font-size: 16px;line-height: 36px;" @click="toStateOne()">待处理<span>&nbsp;{{stmt2}}</span></div></el-col>
                  <el-col :span="4"><div class="grid-content bg-purple" style="font-size: 16px;line-height: 36px;" @click="toStateTwo()">待备货<span>&nbsp;{{stmt3}}</span></div></el-col>
                  <el-col :span="4"><div class="grid-content bg-purple" style="font-size: 16px;line-height: 36px;" @click="toStateThree()">待发货<span>&nbsp;{{stmt4}}</span></div></el-col>
                  <el-col :span="4"><div class="grid-content bg-purple" style="font-size: 16px;line-height: 36px;" @click="toStateFour()">已发货<span>&nbsp;{{stmt5}}</span></div></el-col>
                  <el-col :span="4"><div class="grid-content bg-purple" style="font-size: 16px;line-height: 36px;" @click="toStateFive()">交易完成<span>&nbsp;{{stmt67}}</span></div></el-col>
                  <el-col :span="4"><div class="grid-content bg-purple" style="font-size: 16px;line-height: 36px;" @click="toStateSix()">交易失败<span>&nbsp;{{stmt0102}}</span></div></el-col>
                </el-row>
              </div>
            </div>
          </div>
...
<!--              <img src="../components/icon/pic30.png" style="width:90%;margin-top: 15px">-->
          ...
          <div class="container2" v-else>
            <ul :loading="loadings.table" >
              <li class="container_1" v-for="(order,index) in afterOrders1" :key="index">
                <div style="background-color:rgb(246, 121, 46);height: 50px;border-bottom: 1px solid black;">
                  <span style="font-size: 30px;line-height: 50px;float:left;margin-left: 20px">{{order.startDate.substring(0,10)+"   "+order.startDate.substring(11,16)}}</span>
                </div>
                <div class="container_2">
                  ...
                  <span>
                <h1 style="color: black;font-size: 40px;margin-top:74px;"><b>{{order.number}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;￥{{order.goodPrice}}</b></h1>
                  <el-button class="service"  @click="showPost(order.orderId,order.stmt)" style="">售后处理</el-button>
                    </span>
