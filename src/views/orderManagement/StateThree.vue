      ...
      <ul    :loading="loadings.table" >
        <li class="container_1" v-for="(order,index) in allOrders" @click="toGoodDetail(order.goodId)" :key="index">
          ...
          <span class="container1-3">
            ...
            <el-button class="button2" type="text" @click.stop @click="deliverGoods(order.orderId)"><span style="color: black;">去发货</span></el-button>
...
<script>
  ...
  import {deliverGoods, sellerCancelAnOrder, showOrders,} from "../../api";
