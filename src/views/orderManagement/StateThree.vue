      ...
      <ul v-else :loading="loadings.table" >
        <li class="container_1" v-for="(order,index) in allOrder" :key="index">
          <div style="background-color:rgb(246, 121, 46);height: 50px;border-bottom: 1px solid black;">
            ...
            <el-button class="button2"  @click="deliverGoods(order[0].orderId)"><span style="color: black;">去发货</span></el-button>
...
<script>
  ...
  import {deliverGoods, getBuyerInformation, sellerCancelAnOrder, showOrders,} from "../../api";
